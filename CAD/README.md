...
<img src="Images/assembly.jpeg" alt="Alt text" width="80%" />

## Printing Orientation:
A Bambu Studio printer was used with standard black PLA filament. The printing orientation was optimized for better surface texture. It was found to be best to orient the top part with the open side facing down, and the bottom part with the open side facing up. The open side is the side where the components are mounted. Printing at a slower speed with a layer height of 0.1 mm per slice produced the most uniform and pleasant-to-touch surface.

<img src="Images/enclosure.png" alt="Alt text" width="30%" />

## Further Work:
The USB-C port access could be improved and the fixtures changed to more durable solutions, for a final design. 

## References: 
The CAD was mainly influenced by the design analysis from Markus Glavind and Brandt Gregersen Gustav found here: 
